    ...
    <section class="content-header">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="<?php echo url('User/personInfo'); ?>">
                    < &nbsp;
                </a>
            </li>
                ...
                <div class="box-body">
                    <form action="#" method="post" enctype="multipart/form-data">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input disabled="" name="moble" value="<?php echo htmlentities($userInfo['moble']); ?>" class="form-control" id="moble">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="btn btn-primary btn-lg btn-block personInfo" data-send-href="<?php echo url('personalChangeMobileSubmit'); ?>" value="<?php echo lang('sure'); ?>" readonly />
                            </div>
                        </div>
                    </form>
                    <!-- /.row -->
...
$(function () {
    ...
    $("body").on("click", ".sendCode", function () {
        ...
        sendStatus = 1;
        $.post("<?php echo url('/index/User/sendMobileCode'); ?>",senData,
            function(res){
                var res = JSON.parse(res);
                // layer.open({
                //     content: res.info
