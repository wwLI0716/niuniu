                                ...
                                <form id="examineInfo" name="examineInfo" action="<?php echo url('getreleaseExamine'); ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row special-row">
                                            <textarea class="form-control" name="management_reason_1" id="management_reason_1" rows="5"><?php if($examineInfo['management_reason_1'] == ''): ?>请输入审核意见<?php else: ?><?php echo htmlentities($examineInfo['management_reason_1']); endif; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="row special-row">
                                            <textarea class="form-control" name="management_reason_2" id="management_reason_2" rows="5"><?php if($examineInfo['management_reason_2'] == ''): ?>请输入审核意见<?php else: ?><?php echo htmlentities($examineInfo['management_reason_2']); endif; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="row special-row">
                                            <textarea class="form-control" name="management_reason_3" id="management_reason_3" rows="5"><?php if($examineInfo['management_reason_3'] == ''): ?>请输入审核意见<?php else: ?><?php echo htmlentities($examineInfo['management_reason_3']); endif; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="row special-row">
                                            <textarea class="form-control" name="management_reason_4" id="management_reason_4" rows="5"><?php if($examineInfo['management_reason_4'] == ''): ?>请输入审核意见<?php else: ?><?php echo htmlentities($examineInfo['management_reason_4']); endif; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="row special-row">
                                            <textarea class="form-control" name="management_reason_5" id="management_reason_5" rows="5"><?php if($examineInfo['management_reason_5'] == ''): ?>请输入审核意见<?php else: ?><?php echo htmlentities($examineInfo['management_reason_5']); endif; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="row special-row">
                                            <textarea class="form-control" name="management_examine_reason" id="management_examine_reason" rows="5"><?php if($examineInfo['management_examine_reason'] == ''): ?>请输入审核意见<?php else: ?><?php echo htmlentities($examineInfo['management_examine_reason']); endif; ?></textarea>
                                        </div>
                                    </div>
...
$(function () {
    ...
    $('.toUrl').click(function(){
        if($(this).val() == "同意")
        {
            ...
            $("#management_examine_status").val(0);
        }
        $("#examineInfo").submit(function(){
            ...
            layer.open({
                ...
                ,yes: function(index){
                    ...
                    //1.发送数据到服务器
                    $.post("<?php echo url('Examine/getmanagementExamine'); ?>",forthat.serialize(),function(res){
                        var res = JSON.parse(res);
                        layer.closeAll();
