<?php /*a:4:{s:97:"/www/wwwroot/rent.niuguagua.com/application/index/view/index/index_mobile_management_examine.html";i:1585704771;s:77:"/www/wwwroot/rent.niuguagua.com/application/index/view/public/mobilehead.html";i:1585684142;s:71:"/www/wwwroot/rent.niuguagua.com/application/index/view/public/left.html";i:1579008137;s:73:"/www/wwwroot/rent.niuguagua.com/application/index/view/public/bottom.html";i:1579008099;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
    ...
    <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu" style="position: relative;width: 20%;text-align: center;">
                ...
                <li class="dropdown user user-menu" style="position: relative;width: 60%;text-align: center;">
                    <input type="text" style="background-color: #fff;height: 36px;line-height: 36px;margin-top: 12px;border-radius: 15px;" name="name" class="form-control" placeholder="请输入关键字搜索" value="<?php echo htmlentities($name); ?>" />
                    <i class="iconfont icon-sousuo" style="margin-right: 0;font-size: 2rem;position: absolute;right: 10px;top: 12px;"></i>
                </li>
                <?php if($userrole != '村企业'): ?>
                <li class="dropdown user user-menu" style="position: relative;width: 20%;text-align: center;">
                ...
                <?php else: ?>
                <li class="dropdown user user-menu" style="position: relative;width: 20%;text-align: center;">
                    <a href="/Examine/releaseDemand" class="dropdown-toggle">
                        <i class="iconfont icon-icon-test" style="margin-right: 0;font-size: 2.5rem;"></i>
                    </a>
                </li>
                <?php endif; ?>
            </ul>
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 show-auto" style="width: 48%;">
                <div class="box pull-up">
                    <select class="form-control investment_mode" name="countryid">
                        <option value="">选择村企业</option>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 show-auto" style="width: 48%;">
                <div class="box pull-up">
                    <select class="form-control investment_mode" name="type">
                        <option value="">选择审核流程</option>
...
<script>
    ...
    $(function () {
        ...
        $("select[name='status']").change(function(){
            window.location.href = "/index?status=&countryid=" + $("select[name='countryid']").val() + "&type=" + $("select[name='type']").val() + "&name=" + $("input[name='name']").val();
        });
