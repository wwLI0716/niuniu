<?php /*a:1:{s:79:"/www/wwwroot/rent.niuguagua.com/application/admin/view/usernotice/sms_list.html";i:1578234014;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use(['table', 'jquery','laydate'], function () {
        ...
        table.render({
            elem: '#list',
            url: "<?php echo url('usernotice/index'); ?>", //数据接口
            title: '用户通知日志表',
            toolbar: 'true',
            ...
            cols: [[
                ...
                {field: 'description', title: '通知内容', sort: true,width:350},
        ...
        var active = {
            del: function () {
                ...
                layer.confirm('确定删除吗？', function (index) {
                    $.post("<?php echo url('usernotice/delSms'); ?>", {id: ids}, function (res) {
                        if (res.code === 1) {
                            layer.close(index);
                            table.reload('list');
                            layer.msg(res.msg);
        ...
        table.on('tool(list)', function (obj) {
            ...
            if (layEvent === 'del') {
                layer.confirm('真的删除行么', function (index) {
                    $.post('<?php echo url("usernotice/delSms"); ?>', {id: [data.id]}, function (res) {
                        if (res.code === 1) {
                            obj.del();
                            layer.close(index);
                            layer.msg(res.msg);
