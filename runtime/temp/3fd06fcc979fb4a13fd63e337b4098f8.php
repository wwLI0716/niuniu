<?php /*a:4:{s:111:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\index\index_management_examine.html";i:1588744476;s:92:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\public\head.html";i:1595813867;s:92:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\public\left.html";i:1594024606;s:94:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\public\bottom.html";i:1588746419;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-lg-1 col-md-2 col-sm-2 show-auto margin-top-20">
                <div class="box pull-up">
                    <input type="text" id="start_time" name="start_time" class="form-control datepicker start_time" placeholder="开始时间" value="<?php echo htmlentities($start_time); ?>" />
                </div>
            </div>
            <div class="col-lg-1 col-md-2 col-sm-2 show-auto margin-top-20">
                <div class="box pull-up">
                    <input type="text" id="end_time" name="end_time" class="form-control datepicker end_time" placeholder="结束时间" value="<?php echo htmlentities($end_time); ?>" />
                </div>
            </div>
            ...
            <div class="col-lg-1 col-md-2 col-sm-1 show-auto margin-top-20">
                <div class="box pull-up">
                    <input id="export" class="btn btn-info btn-lg btn-block"value="导出" readonly="">
                </div>
            </div>
        </div>
        <!-- RENOVATION -->
...
<script>
    ...
    $(function () {
        ...
        $(".submit").click(function(){
            window.location.href = "/index?status=" + $("select[name='status']").val() + "&countryid=" + $("select[name='countryid']").val() +
                "&type=" + $("select[name='type']").val() + "&name=" + $("input[name='name']").val() + "&person=" + $("input[name='person']").val() +
        ...
        $("#export").off("click").click(function() {
            ...
            window.location.href = "/Examine/exportData?status="+ $("select[name='status']").val() + "&countryid=" + $("select[name='countryid']").val() +
                "&type=" + $("select[name='type']").val() + "&name=" + $("input[name='name']").val() + "&person=" + $("input[name='person']").val() +
                "&start_time=" + $("input[name='start_time']").val() +  "&end_time=" + $("input[name='end_time']").val();
