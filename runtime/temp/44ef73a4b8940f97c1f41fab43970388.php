<?php /*a:4:{s:105:"/www/wwwroot/rent.niuguagua.com/application/index/view/examine/see_demand_jing_before_examine_result.html";i:1585708507;s:72:"/www/wwwroot/rent.niuguagua.com/application/index/view/public/shead.html";i:1585686728;s:71:"/www/wwwroot/rent.niuguagua.com/application/index/view/public/left.html";i:1579008137;s:73:"/www/wwwroot/rent.niuguagua.com/application/index/view/public/bottom.html";i:1579008099;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
                        ...
                        <div class="col-lg-12">
                            <div class="table-container show-module-content">
                                <form id="examineInfo" name="examineInfo" method="post">
                                    ...
                                    <div class="row special-row">
                                        <?php if(is_array($examinesInfo) || $examinesInfo instanceof \think\Collection || $examinesInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $examinesInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['jing_before_examine_status'] != 0): ?>
                                        <div class="col-lg-12 col-md-12 margin-top-10 margin-bottom-10 specia-m">
                                            <div class="index_message">
                                                <p class="p1">
                                                    <span class="company">镇经管办预审</span>
                                                    <?php if($vo['jing_before_examine_status'] == 0): ?>
                                                    <span class="examineStatus"><span class="iconfont icon-weishenhe"></span>未审核</span>
                                                    <?php elseif($vo['jing_before_examine_status'] == 1): ?>
                                                ...
                                                <p class="p2">审核意见：<?php if($vo['jing_before_examine_reason'] != ''): ?><?php echo htmlentities($vo['jing_before_examine_reason']); else: ?>无<?php endif; ?></p>
                                                <p class="p2"><span class="iconfont icon-shijian"></span>提交时间：<?php if($vo['jing_before_time'] != 0): ?><?php echo date('Y-m-d H:i:s',$vo['jing_before_time']); endif; ?></p>
                                                <p class="p2 p3"><a href="/examine/jingBeforeMore?demandId=<?php echo htmlentities($vo['id']); ?>">查看更多</a></p>
                                            </div>
                                        </div>
