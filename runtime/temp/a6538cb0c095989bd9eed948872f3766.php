<?php /*a:4:{s:98:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\his\show_his_list.html";i:1595675419;s:92:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\public\head.html";i:1595813867;s:92:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\public\left.html";i:1594024606;s:94:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\public\bottom.html";i:1588746419;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<!--            </div>-->
            <div class="col-lg-1 col-md-4 col-sm-8 show-auto margin-top-20">
                <div class="box pull-up">
                    <?php if($role == 0): ?>
                    <a href="/His/saveView" style="padding-left: 0;padding-right: 0;" class="btn btn-info btn-lg btn-block submit">+ 创建发布</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12 col-md-12 margin-top-20">
                <table style="width: 100%;background-color: #fff;line-height: 50px;text-align: center;">
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlentities($vo['rent_house']); ?></td>
                        <td><?php echo htmlentities($vo['rent_floor']); ?></td>
                        <td><?php echo htmlentities($vo['rent_area']); ?></td>
                        <td><?php echo htmlentities($vo['rent_price']); ?></td>
                       ...
                       --> <td>
                            <button style="line-height: 30px;" type="button" class="btn btn-primary"><a style="color: #fff;" href="/His/viewBid?bidId=<?php echo htmlentities($vo['id']); ?>">查看</a></button>
