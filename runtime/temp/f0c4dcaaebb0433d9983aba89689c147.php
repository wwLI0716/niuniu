<?php /*a:4:{s:103:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\examine\release_demand.html";i:1592548070;s:93:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\public\shead.html";i:1586950450;s:92:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\public\left.html";i:1587133078;s:94:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\public\bottom.html";i:1588746419;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
        ...
        <div class="col-12">
            <div class="box box-solid bg-black">
                <div class="box-body">
                    <div class="row">
                        <div class="col-12">
                            <form id="demandInfo" name="demandInfo" action="<?php echo url('getreleaseDemand'); ?>"
                                ...
                                <input type="hidden" id="methods" name="methods" value="">
                                <div>
                                    <div class="show-module-content">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 input-group">
                                                <input type="text" name="house_name" class="form-control"
                                                       placeholder="请输入楼宇名称" value="<?php echo htmlentities($demondInfo['house_name']); ?>"/>
                                                <?php if(!isset($demondInfo)): ?><span
                                                    class="input-group-addon specSearch">搜索</span><?php endif; ?>
                                            </div>
                                            <label class="col-sm-2 col-form-label">楼宇地址</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="house_address" class="form-control"
                                                       placeholder="请输入楼宇地址" value="<?php echo htmlentities($demondInfo['house_address']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">地上层数/层</label>
                                            <div class="col-sm-4">
                                                <input type="number" name="house_up_height" class="form-control"
                                                       placeholder="请输入地上层数" value="<?php echo htmlentities($demondInfo['house_up_height']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">地下层数/层</label>
                                            <div class="col-sm-4">
                                                <input type="number" name="house_down_height" class="form-control"
                                                       placeholder="请输入地下层数" value="<?php echo htmlentities($demondInfo['house_down_height']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">地上面积</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="house_up_area" class="form-control"
                                                       placeholder="请输入地上面积" value="<?php echo htmlentities($demondInfo['house_up_area']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">地下面积</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="house_down_area" class="form-control"
                                                       placeholder="请输入地下面积" value="<?php echo htmlentities($demondInfo['house_down_area']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <select name="investment_mode" class="form-control investment_mode">
                                                    ...
                                                    <option value="<?php echo htmlentities($vo); ?>" {if
                                                            condition="$demondInfo.investment_mode eq $vo"
                                                            }selected="selected" {
                                                    /if}><?php echo htmlentities($vo); ?></option>
                                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </div>
                                            <label class="col-sm-2 col-form-label">投资比例%</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="investment_rate" class="form-control"
                                                       placeholder="请输入投资比例" value="<?php echo htmlentities($demondInfo['investment_rate']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">投资总额/万</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="investment_total" class="form-control"
                                                       placeholder="请输入投资总额/万" value="<?php echo htmlentities($demondInfo['investment_total']); ?>"/>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <select name="house_nature" class="form-control house_nature">
                                                    ...
                                                    <option value="<?php echo htmlentities($vo); ?>" {if
                                                            condition="$demondInfo.house_nature eq $vo"
                                                            }selected="selected" {
                                                    /if}><?php echo htmlentities($vo); ?></option>
                                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" id="build_at" name="build_at"
                                                       class="form-control datepicker" placeholder="请输入开工时间"
                                                       value="<?php echo htmlentities($demondInfo['build_at']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">竣工时间</label>
                                            <div class="col-sm-4">
                                                <input type="text" id="finished_at" name="finished_at"
                                                       class="form-control datepicker" placeholder="请输入竣工时间"
                                                       value="<?php echo htmlentities($demondInfo['finished_at']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">房产权证号</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="house_card_number" class="form-control"
                                                       placeholder="请输入房产权证号" value="<?php echo htmlentities($demondInfo['house_card_number']); ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="show-module-content" style="display: none;">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="original_tenant" class="form-control"
                                                       placeholder="请输入原租赁方" value="<?php echo htmlentities($demondInfo['original_tenant']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">租赁开始时间</label>
                                            <div class="col-sm-4">
                                                <input type="text" id="lease_start" name="lease_start"
                                                       class="form-control datepicker lease_start"
                                                       placeholder="请输入租赁开始时间" value="<?php echo htmlentities($demondInfo['lease_start']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">租赁结束时间</label>
                                            <div class="col-sm-4">
                                                <input type="text" id="lease_end" name="lease_end"
                                                       class="form-control datepicker lease_end" placeholder="请输入租赁结束时间"
                                                       value="<?php echo htmlentities($demondInfo['lease_end']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">租赁位置</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="lease_position" class="form-control"
                                                       placeholder="请输入租赁位置" value="<?php echo htmlentities($demondInfo['lease_position']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">地上位置/层</label>
                                            <div class="col-sm-4">
                                                <input type="number" name="up_position" class="form-control"
                                                       placeholder="请输入地上位置" value="<?php echo htmlentities($demondInfo['up_position']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">地下位置/层</label>
                                            <div class="col-sm-4">
                                                <input type="number" name="down_position" class="form-control"
                                                       placeholder="请输入地下位置" value="<?php echo htmlentities($demondInfo['down_position']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">租赁面积</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="lease_area" class="form-control"
                                                       placeholder="请输入租赁面积" value="<?php echo htmlentities($demondInfo['lease_area']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">地上面积</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="lease_up_area"
                                                       class="form-control" placeholder="请输入租赁地上面积"
                                                       value="<?php echo htmlentities($demondInfo['lease_up_area']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">地下面积</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="lease_down_area"
                                                       class="form-control" placeholder="请输入租赁地下面积"
                                                       value="<?php echo htmlentities($demondInfo['lease_down_area']); ?>"/>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <select name="end_reason" class="form-control end_reason">
                                                    ...
                                                    <option value="<?php echo htmlentities($vo); ?>" {if condition="$demondInfo.end_reason eq $vo"
                                                            }selected="selected" {
                                                    /if}><?php echo htmlentities($vo); ?></option>
                                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" id="lease_end_day" name="lease_end_day"
                                                       class="form-control datepicker lease_end_day"
                                                       placeholder="请输入合同终止日" value="<?php echo htmlentities($demondInfo['lease_end_day']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">租赁单价/元</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="lease_price" class="form-control"
                                                       placeholder="请输入租赁单价/元" value="<?php echo htmlentities($demondInfo['lease_price']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">物业管理费/元</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="lease_manager_price"
                                                       class="form-control" placeholder="请输入物业管理费/元"
                                                       value="<?php echo htmlentities($demondInfo['lease_manager_price']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">递增方式</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="incremental_way" class="form-control"
                                                       placeholder="请输入递增方式" value="<?php echo htmlentities($demondInfo['incremental_way']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">退租违约金/元</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="falsify" class="form-control"
                                                       placeholder="请输入退租违约金/元" value="<?php echo htmlentities($demondInfo['falsify']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">房屋保证金/元</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="house_deposit"
                                                       class="form-control" placeholder="请输入房屋保证金/元"
                                                       value="<?php echo htmlentities($demondInfo['house_deposit']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">风险保证金/元</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="risk_deposit" class="form-control"
                                                       placeholder="请输入风险保证金/元" value="<?php echo htmlentities($demondInfo['risk_deposit']); ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="show-module-content" style="display: none;">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">租赁位置</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="lease_position_now" class="form-control"
                                                       placeholder="请输入租赁位置" value="<?php echo htmlentities($demondInfo['lease_position_now']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">地上位置</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="up_position_now"
                                                       class="form-control" placeholder="请输入地上位置"
                                                       value="<?php echo htmlentities($demondInfo['up_position_now']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">地下位置</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="down_position_now"
                                                       class="form-control" placeholder="请输入地下位置"
                                                       value="<?php echo htmlentities($demondInfo['down_position_now']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">租赁面积</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="lease_area_now"
                                                       class="form-control" placeholder="请输入租赁面积"
                                                       value="<?php echo htmlentities($demondInfo['lease_area_now']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">地上面积</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="lease_up_area_now"
                                                       class="form-control" placeholder="请输入地上面积"
                                                       value="<?php echo htmlentities($demondInfo['lease_up_area_now']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">地下面积</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="lease_down_area_now"
                                                       class="form-control" placeholder="请输入地下面积"
                                                       value="<?php echo htmlentities($demondInfo['lease_down_area_now']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">租赁年限/年</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="lease_year" class="form-control"
                                                       placeholder="请输入租赁年限/年" value="<?php echo htmlentities($demondInfo['lease_year']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">租赁开始时间</label>
                                            <div class="col-sm-4">
                                                <input type="text" id="lease_start_now" name="lease_start_now"
                                                       class="form-control datepicker lease_start_now"
                                                       placeholder="请输入租赁开始时间" value="<?php echo htmlentities($demondInfo['lease_start_now']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">租赁结束时间</label>
                                            <div class="col-sm-4">
                                                <input type="text" id="lease_end_now" name="lease_end_now"
                                                       class="form-control datepicker lease_end_now"
                                                       placeholder="请输入租赁结束时间" value="<?php echo htmlentities($demondInfo['lease_end_now']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">免租期/天</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="rent_free_period"
                                                       class="form-control" placeholder="请输入免租期/天"
                                                       value="<?php echo htmlentities($demondInfo['rent_free_period']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">租金起算日</label>
                                            <div class="col-sm-4">
                                                <input type="text" id="rent_start_day" name="rent_start_day"
                                                       class="form-control datepicker rent_start_day"
                                                       placeholder="请输入租金起算日" value="<?php echo htmlentities($demondInfo['rent_start_day']); ?>"/>
                                            </div>
                                            <!--                                            租赁单价有的是按每月/每套算的，按每平方米/每天算的  输入由用户自定义-->
                                            <label class="col-sm-2 col-form-label">租赁单价/元</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="lease_price_now"
                                                       class="form-control" placeholder="请输入租赁单价/元"
                                                       value="<?php echo htmlentities($demondInfo['lease_price_now']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">物业管理费/元</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="lease_manager_price_now"
                                                       class="form-control" placeholder="请输入物业管理费/元"
                                                       value="<?php echo htmlentities($demondInfo['lease_manager_price_now']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">递增方式</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="incremental_way_now" class="form-control"
                                                       placeholder="请输入递增方式" value="<?php echo htmlentities($demondInfo['incremental_way_now']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">退租违约金/元</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="falsify_now" class="form-control"
                                                       placeholder="请输入退租违约金/元" value="<?php echo htmlentities($demondInfo['falsify_now']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">房屋保证金/元</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="house_deposit_now"
                                                       class="form-control" placeholder="请输入房屋保证金/元"
                                                       value="<?php echo htmlentities($demondInfo['house_deposit_now']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">风险保证金/元</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="risk_deposit_now"
                                                       class="form-control" placeholder="请输入风险保证金/元"
                                                       value="<?php echo htmlentities($demondInfo['risk_deposit_now']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">意向承租企业名称</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="lease_unit" class="form-control"
                                                       placeholder="请输入意向承租企业名称" value="<?php echo htmlentities($demondInfo['lease_unit']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">企业性质</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="lease_unit_nature" class="form-control"
                                                       placeholder="请输入企业性质" value="<?php echo htmlentities($demondInfo['lease_unit_nature']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">注册资金/万</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="register_capital"
                                                       class="form-control" placeholder="请输入注册资金/万"
                                                       value="<?php echo htmlentities($demondInfo['register_capital']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">经营范围</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="business_scope" class="form-control"
                                                       placeholder="请输入经营范围" value="<?php echo htmlentities($demondInfo['business_scope']); ?>"/>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <select name="tax_landing" class="form-control tax_landing">
                                                    ...
                                                    <option value="<?php echo htmlentities($vo); ?>" {if condition="$demondInfo.tax_landing eq $vo"
                                                            }selected="selected" {
                                                    /if}><?php echo htmlentities($vo); ?></option>
                                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                              ...
                                              <input type="checkbox" name="purpose" value="Car" checked="checked" />
                                               <!-- <select name="purpose" class="form-control purpose">
                                                    ...
                                                    <option value="<?php echo htmlentities($vo); ?>" {if condition="$demondInfo.purpose eq $vo"
                                                            }selected="selected" {
                                                    /if}><?php echo htmlentities($vo); ?></option>
                                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>-->
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="management_state" class="form-control"
                                                       placeholder="请输入实际经营状态" value="<?php echo htmlentities($demondInfo['management_state']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">上年度税收</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="last_tax" class="form-control"
                                                       placeholder="请输入上年度税收" value="<?php echo htmlentities($demondInfo['last_tax']); ?>"/>
                                            </div>
                                            <label class="col-sm-2 col-form-label">承诺实际税收/万</label>
                                            <div class="col-sm-4">
                                                <input type="number" step="0.01" name="real_tax" class="form-control"
                                                       placeholder="请输入承诺实际税收/万" value="<?php echo htmlentities($demondInfo['real_tax']); ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <textarea class="form-control col-sm-6" name="explain" id="explain"
                                                      rows="5"><?php if(isset($demondInfo['explain']) && $demondInfo['explain'] != ''): ?><?php echo htmlentities($demondInfo['explain']); else: ?>特殊情况说明<?php endif; ?></textarea>
                                            <input type="hidden" id="annex_address" name="annex_address"
                                                   placeholder="请上传附件" value="<?php echo htmlentities($demondInfo['annex_address']); ?>"/>
                                            <label class="col-sm-2 col-form-label showNowAnnex"><?php if($demondInfo['annex_address'] == ''): ?>上传附件<?php else: ?><a
                                                        class="nowAnnex" href="<?php echo htmlentities($demondInfo['annex_address']); ?>"
                                                        download="<?php echo htmlentities($demondInfo['annex_address']); ?>">当前附件</a><?php endif; ?></label>
                                            <div class="col-sm-4">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5 col-form-label"></label>
                                    <div class="col-sm-2">
                                        <input class="btn btn-primary btn-lg btn-block submit saves" type="submit"
                                               value="保存" readonly/>
                                    </div>
                                </div>
                            </form>
