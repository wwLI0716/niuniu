...
<div class="content-wrapper">
    <section class="content-header show-content-title">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active sendContent">镇领导</li>
        </ol>
    </section>
                        ...
                        <div class="col-lg-12">
                            <div class="table-container show-module-content">
                                <form id="examineInfo" name="examineInfo" action="<?php echo url('getreleaseExamine'); ?>" method="post">
                                    ...
                                    <input type="hidden" id="town_examine_status" name="town_examine_status" value="0">
                                    <h1 class="show-title show-title-special">审核信息</h1>
                                    <div class="form-group">
                                        <div class="row special-row">
                                            <textarea class="form-control" name="town_examine_reason" id="town_examine_reason" rows="5"><?php if($examineInfo['town_examine_reason'] == ''): ?>请输入审核意见<?php else: ?><?php echo htmlentities($examineInfo['town_examine_reason']); endif; ?></textarea>
                                        </div>
                                    </div>
...
$(function () {
    ...
    $('.toUrl').click(function(){
        if($(this).val() == "同意")
        {
            $("#town_examine_status").val(1);
        } else {
            $("#town_examine_status").val(0);
        }
        $("#examineInfo").submit(function(){
            ...
            layer.open({
                ...
                ,yes: function(index){
                    ...
                    //1.发送数据到服务器
                    $.post("<?php echo url('Examine/gettownExamine'); ?>",forthat.serialize(),function(res){
                        var res = JSON.parse(res);
                        layer.closeAll();
