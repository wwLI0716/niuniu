...
<div class="content-wrapper">
    ...
    <section class="content-header header-top">
        <div class="col-lg-12">
            ...
            <input class="btn btn-primary btn-lg btn-block senData" data-send-href="<?php echo url('messageSubmit'); ?>" value="<?php echo lang('sure'); ?>" readonly />
        </div>
    </section>
</div>
</div>
