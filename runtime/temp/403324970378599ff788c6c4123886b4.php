                            ...
                            <div class="table-container table-responsive show-module-content" style="position: relative;">
                                ...
                                <section class="cd-horizontal-timeline loaded" style="margin: .1rem 5px 1rem 5px;">
                                        ...
                                        <div class="events-wrapper">
                                            <div class="events" style="width: 100%;">
                                                <ol>
                                                    ...
                                                    <li>
                                                        <?php if($demondInfo['apple_process_type'] == 0): ?>
                                                            <a href="javascript:void(0)" <?php if(($examineInfo['finance_examine_status'] == 1) && ($examineInfo['jing_examine_status'] == 1) && ($examineInfo['farmer_examine_status'] == 1) && ($examineInfo['audit_examine_status'] == 1) && ($examineInfo['assets_examine_status'] == 1) && ($examineInfo['security_examine_status'] == 1)): ?> class="selected" <?php endif; ?> style="left: 45%">6部门</a>
                                                        <?php else: if($demondInfo['apple_is_soft_first'] == 1): ?>
                                                                <a href="javascript:void(0)" <?php if($examineInfo['security_examine_status'] == 1): ?>class="selected"<?php endif; ?> style="left: 45%">6部门</a>
                                                            <?php else: ?>
                                                                <a href="javascript:void(0)" class="selected" style="left: 45%">6部门</a>
                                                            <?php endif; endif; ?>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <?php else: ?>
                                                        <a href="javascript:void(0)" <?php if($examineInfo['management_examine_status'] == 1): ?>class="selected"<?php endif; ?> style="left: 85%">镇领导</a>
                                                        <?php endif; ?>
                                                    </li>
                                                </ol>
                                    ...
                                    <div>
                                        ...
                                        <?php if($examineInfo['security_examine_status'] == 0): ?>安全办、<?php endif; if($examineInfo['management_examine_status'] == 0): ?>经管办、<?php endif; ?>未审核
                                ...
                                <div class="row special-row">
                                    ...
                                    <?php if($demondInfo['apple_process_type'] == 0): ?><!--,常规流程需要安全预审-->
                                    ...
                                    <?php endif; if(($role == 9) && ($examineInfo['town_examine_status'] == 0)): ?>
                                    <div class="index_message">
                                        <a class="btn btn-primary btn-lg btn-block edit" href="/Examine/townDemand?demandId=<?php echo htmlentities($examineInfo['id']); ?>">去审核</a>
                                    </div>
                                    <?php endif; ?>
                                    </div>
                                </div>
