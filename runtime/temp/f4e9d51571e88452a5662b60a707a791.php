<?php /*a:4:{s:100:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\index\index_finance.html";i:1592314330;s:92:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\public\head.html";i:1595813867;s:92:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\public\left.html";i:1594024606;s:94:"F:\ruanjian\wampServer\wamp64\www\rent.niuguagua.com\application\index\view\public\bottom.html";i:1588746419;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<div class="content-wrapper">
    ...
    <section class="content">
                    ...
                    <div class="box-body tickers-block webticker-3">
                        <ul id="webticker-2">
                            ...
                            <li>
                                ...
                                <a href="/Examine/seeDemand?demandId=<?php echo htmlentities($vo['apple_id']); ?>">您的<?php echo htmlentities($vo['description']); ?></a>
                            </li>
        ...
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-2 show-auto margin-top-20">
                <div class="box pull-up">
                    <select class="form-control investment_mode" name="status">
                      ...
                      <option value="4" <?php if($status == 4): ?>selected="selected"<?php endif; ?>>草稿箱</option>
                    </select>
                </div>
            </div>
            <!--<div class="col-lg-2 col-md-2 col-sm-2 show-auto margin-top-20">
            ...
            <div class="col-lg-1 col-md-2 col-sm-2 show-auto margin-top-20">
                <div class="box pull-up">
            ...
            <div class="col-lg-1 col-md-2 col-sm-2 show-auto margin-top-20">
                <div class="box pull-up">
                    <input type="text" id="start_time" name="start_time" class="form-control datepicker start_time flatpickr-input" placeholder="输入开始时间" value="<?php echo htmlentities($start_time); ?>" />
                </div>
            </div>
            <div class="col-lg-1 col-md-2 col-sm-2 show-auto margin-top-20">
                <div class="box pull-up">
                <input type="text" id="end_time" name="end_time" class="form-control datepicker end_time flatpickr-input" placeholder="输入结束时间" value="<?php echo htmlentities($end_time); ?>" />
                </div>
            </div>
            ...
            <div class="col-lg-1 col-md-1 col-sm-1 show-auto margin-top-20">
                <div class="box pull-up">
                    <a href="/Examine/releaseDemand" style="padding-left: 0;padding-right: 0;" class="btn btn-info btn-lg btn-block submit">+ 创建发布</a>
                </div>
            </div>
        </div>
        <!-- RENOVATION -->
            ...
            <div class="col-lg-12 col-md-12 margin-top-20">
                <table style="width: 100%;background-color: #fff;line-height: 50px;text-align: center;">
                    ...
                    <tr>
                        ...
                        <td><span class="doing"><?php if($vo['apple_status'] == 0): ?><button type="button" class="btn btn-info show-status">待审核</button><?php elseif($vo['apple_status'] == 1): ?><button type="button" class="btn btn-warning show-status">审核中</button><?php elseif($vo['apple_status'] == 2): ?><button type="button" class="btn btn-success show-status">审核通过</button><?php elseif($vo['apple_status'] == 4): ?><button type="button" class="btn btn-success show-status">草稿箱</button><?php else: ?><button type="button" class="btn btn-danger show-status">审核驳回</button><?php endif; ?></span></td>
                        <td><button style="line-height: 30px;" type="button" class="btn btn-primary"><a style="color: #fff;" href="/Examine/seeDemand?demandId=<?php echo htmlentities($vo['apple_id']); ?>">查看</a></button><?php if($vo['apple_status'] == 4): ?><td><button style="line-height: 30px;" type="button" class="btn btn-primary"><a style="color: #fff;" href="/Examine/releaseDemandStatus?demandId=<?php echo htmlentities($vo['apple_id']); ?>">编辑草稿</a></button></td><?php endif; ?></td>
                      
                    </tr>
                    <a href="/Examine/seeDemand?demandId=<?php echo htmlentities($vo['apple_id']); ?>">
                        <!--<div class="index_message">
                            <div>
                                <div>
                                    <p class="p2"><?php echo htmlentities($vo['house_name']); ?><span class="doing"><?php if($vo['apple_status'] == 0): ?><button type="button" class="btn btn-info show-status">待审核</button><?php elseif($vo['apple_status'] == 1): ?><button type="button" class="btn btn-warning show-status">审核中</button><?php elseif($vo['apple_status'] == 2): ?><button type="button" class="btn btn-success show-status">审核通过</button><?php else: ?><button type="button" class="btn btn-danger show-status">审核驳回</button><?php endif; ?></span></p>

                                    <p class="p2">提交时间： <?php echo date('Y-m-d H:i:s',$vo['updated_at']); ?></p>
                                </div>
                            </div>
                            <p class="p3"><button type="button" class="btn btn-primary">查看</button></p>
                        </div>-->
                    </a>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
...
<script>
    ...
    $(function () {
        ...
        $(".submit").click(function(){
           window.location.href = "/index/index?status=" + $("select[name='status']").val() + "&countryid=" +"&type=" + $("select[name='type']").val() +
               "&name=" + $("input[name='name']").val() + "&person=" + $("input[name='person']").val() +
               "&start_time=" + $("input[name='start_time']").val() +  "&end_time=" + $("input[name='end_time']").val();
        });
