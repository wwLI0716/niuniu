<?php /*a:1:{s:72:"/www/wwwroot/rent.niuguagua.com/application/admin/view/sms/sms_list.html";i:1578234201;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use(['table', 'jquery','laydate'], function () {
        ...
        table.render({
            elem: '#list',
            url: "<?php echo url('sms/index'); ?>", //数据接口
            title: '简讯日志表',
            toolbar: 'true',
            ...
            cols: [[
                ...
                {field: 'code', title: '验证码', sort: true},
        ...
        var active = {
            del: function () {
                ...
                layer.confirm('确定删除吗？', function (index) {
                    $.post("<?php echo url('sms/delSms'); ?>", {id: ids}, function (res) {
                        if (res.code === 1) {
                            layer.close(index);
                            table.reload('list');
                            layer.msg(res.msg);
        ...
        table.on('tool(list)', function (obj) {
            ...
            if (layEvent === 'del') {
                layer.confirm('真的删除行么', function (index) {
                    $.post('<?php echo url("sms/delSms"); ?>', {id: [data.id]}, function (res) {
                        if (res.code === 1) {
                            obj.del();
                            layer.close(index);
                            layer.msg(res.msg);
