        ...
        <div class="col-12">
            <div class="box box-solid bg-black">
                <div class="box-body box-body-spec">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-container table-responsive show-module-content" style="position: relative;">
                                <?php if($demondInfo['apple_status'] == 0): ?><!--未审核-->
                                <div class="show-examine-content">
                                    提交成功，请等待审核！
                                </div>
                                <?php elseif($demondInfo['apple_status'] == 1): ?><!--审核中-->
                                <section class="cd-horizontal-timeline loaded" style="margin: .1rem 5px 1rem 5px;">
                                    <div class="timeline" style="width: 100%;max-width: 100%;">
                                        <div class="events-wrapper">
                                            <div class="events" style="width: 100%;">
                                                <?php if(($demondInfo['apple_process_type'] == 0) && ($demondInfo['apple_is_soft_first'] == 1)): ?><!--,常规流程需要安全预审-->
                                                <ol>
                                                    <li>
                                                        <a href="javascript:void(0)" class="selected" style="left: 5%">提交审核</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" <?php if($examineInfo['status'] == 1): ?> class="selected" <?php endif; ?> style="left: 22%">预审</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" <?php if($examineInfo['security_examine_status'] == 1): ?> class="selected" <?php endif; ?> style="left: 39%">安全办预审</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" <?php if(($examineInfo['finance_examine_status'] == 1) && ($examineInfo['jing_examine_status'] == 1) && ($examineInfo['farmer_examine_status'] == 1) && ($examineInfo['audit_examine_status'] == 1) && ($examineInfo['assets_examine_status'] == 1) && ($examineInfo['security_do_examine_status'] == 1)): ?> class="selected" <?php endif; ?> style="left: 56%">6部门</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" <?php if($examineInfo['management_examine_status'] == 1): ?>class="selected"<?php endif; ?> style="left: 72%">经管办</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" <?php if($examineInfo['town_examine_status'] == 1): ?>class="selected"<?php endif; ?> style="left: 89%">镇领导</a>
                                                    </li>
                                                </ol>
                                                <?php elseif(($demondInfo['apple_process_type'] == 0) && ($demondInfo['apple_is_soft_first'] == 0)): ?><!--,常规流程不需要安全预审-->
                                                <ol>
                                                    <li>
                                                        <a href="javascript:void(0)" class="selected" style="left: 5%">提交审核</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" <?php if($examineInfo['status'] == 1): ?> class="selected" <?php endif; ?> style="left: 25%">预审</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" <?php if(($examineInfo['finance_examine_status'] == 1) && ($examineInfo['jing_examine_status'] == 1) && ($examineInfo['farmer_examine_status'] == 1) && ($examineInfo['audit_examine_status'] == 1) && ($examineInfo['assets_examine_status'] == 1) && ($examineInfo['security_do_examine_status'] == 1)): ?> class="selected" <?php endif; ?> style="left: 45%">6部门</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" <?php if($examineInfo['management_examine_status'] == 1): ?>class="selected"<?php endif; ?> style="left: 65%">经管办</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" <?php if($examineInfo['town_examine_status'] == 1): ?>class="selected"<?php endif; ?> style="left: 85%">镇领导</a>
                                                    </li>
                                                </ol>
                                                <?php elseif(($demondInfo['apple_process_type'] == 1) && ($demondInfo['apple_is_soft_first'] == 1)): ?><!--,简易流程需要安全预审-->
                                                <ol>
                                                    <li>
                                                        <a href="javascript:void(0)" class="selected" style="left: 5%">提交审核</a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)" <?php if($examineInfo['security_examine_status'] == 1): ?> class="selected" <?php endif; ?> style="left: 45%">安全办前置</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" <?php if($examineInfo['management_examine_status'] == 1): ?>class="selected"<?php endif; ?> style="left: 65%">经管办</a>
                                                    </li>
                                                </ol>
                                                <?php else: ?><!--,简易流程不需要安全预审-->
                                                <ol>
                                                    <li>
                                                        <a href="javascript:void(0)" class="selected" style="left: 5%">提交审核</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" <?php if($examineInfo['status'] == 1): ?> class="selected" <?php endif; ?> style="left: 30%">预审</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" <?php if($examineInfo['management_examine_status'] == 1): ?>class="selected"<?php endif; ?> style="left: 60%">经管办</a>
                                                    </li>
                                                </ol>
                                                <?php endif; ?>
                                    ...
                                    <div>
                                        <?php if(($demondInfo['apple_process_type'] == 0) && ($demondInfo['apple_is_soft_first'] == 1)): ?><!--,常规流程需要安全预审-->
                                        <?php if($examineInfo['security_examine_status'] == 0): ?>安全办前置、<?php endif; if($examineInfo['security_do_examine_status'] == 0): ?>安全办、<?php endif; if($examineInfo['finance_examine_status'] == 0): ?>财政所、<?php endif; if($examineInfo['jing_examine_status'] == 0): ?>镇经发办、<?php endif; if($examineInfo['farmer_examine_status'] == 0): ?>农经站、<?php endif; if($examineInfo['audit_examine_status'] == 0): ?>审计办、<?php endif; if($examineInfo['assets_examine_status'] == 0): ?>镇资产公司、<?php endif; if($examineInfo['management_examine_status'] == 0): ?>经管办、<?php endif; if($examineInfo['town_examine_status'] == 0): ?>镇领导、<?php endif; ?>未审核
                                        <?php elseif(($demondInfo['apple_process_type'] == 0) && ($demondInfo['apple_is_soft_first'] == 0)): ?><!--,常规流程不需要安全预审-->
                                        <?php if($examineInfo['security_do_examine_status'] == 0): ?>安全办、<?php endif; if($examineInfo['finance_examine_status'] == 0): ?>财政所、<?php endif; if($examineInfo['jing_examine_status'] == 0): ?>镇经发办、<?php endif; if($examineInfo['farmer_examine_status'] == 0): ?>农经站、<?php endif; if($examineInfo['audit_examine_status'] == 0): ?>审计办、<?php endif; if($examineInfo['assets_examine_status'] == 0): ?>镇资产公司、<?php endif; if($examineInfo['management_examine_status'] == 0): ?>经管办、<?php endif; if($examineInfo['town_examine_status'] == 0): ?>镇领导、<?php endif; ?>未审核
                                        <?php elseif(($demondInfo['apple_process_type'] == 1) && ($demondInfo['apple_is_soft_first'] == 1)): ?><!--,简易流程需要安全预审-->
                                        <?php if($examineInfo['security_examine_status'] == 0): ?>安全办前置、<?php endif; if($examineInfo['management_examine_status'] == 0): ?>经管办、<?php endif; ?>未审核
                                        <?php else: ?><!--,简易流程不需要安全预审-->
                                        <?php if($examineInfo['management_examine_status'] == 0): ?>经管办、<?php endif; ?>未审核
                                        <?php endif; ?>
                                    </div>
                                </section>
                                <div class="row special-row">
                                    ...
                                    <?php if(($demondInfo['apple_process_type'] == 0) && ($demondInfo['apple_is_soft_first'] == 1)): ?><!--,常规流程需要安全预审-->
                                        <div class="index_message">
                                            ...
                                            <p class="p2">审核意见：<?php if($examineInfo['jing_before_examine_reason'] != ''): ?><?php echo htmlentities($examineInfo['jing_before_examine_reason']); else: ?>无<?php endif; ?></p>
                                            <p class="p2"><span class="iconfont icon-shijian"></span>提交时间：<?php if($examineInfo['jing_before_time'] != 0): ?><?php echo date('Y-m-d H:i:s',$examineInfo['jing_before_time']); endif; ?></p>
                                            <p class="p2 p3"><a href="/examine/jingBeforeMore?demandId=<?php echo htmlentities($examineInfo['id']); ?>">查看更多</a></p>
                                        </div>
                                        <div class="index_message">
                                            <p class="p1">
                                                <span class="company">安全办前置</span>
                                                <?php if($examineInfo['security_examine_status'] == 0): ?>
                                                <span class="examineStatus"><span class="iconfont icon-weishenhe"></span>未审核</span>
                                                <?php elseif($examineInfo['security_examine_status'] == 1): ?>
                                                <span class="examineStatus"><span class="iconfont icon-pass-2-copy"></span>审核通过</span>
                                                <?php else: ?>
                                                <span class="examineStatus"><span class="iconfont icon-shenhebohui"></span>审核驳回</span>
                                                <?php endif; ?>
                                            </p>
                                            <p class="p2">审核意见：<?php if($examineInfo['security_examine_reason'] != ''): ?><?php echo htmlentities($examineInfo['security_examine_reason']); else: ?>无<?php endif; ?></p>
                                            <p class="p2"><span class="iconfont icon-shijian"></span>提交时间：<?php if($examineInfo['security_time'] != 0): ?><?php echo date('Y-m-d H:i:s',$examineInfo['security_time']); endif; ?></p>
                                            <?php if($examineInfo['security_examine_status'] != 0): ?>
                                            <p class="p2 p3"><a href="/examine/securityMore?demandId=<?php echo htmlentities($examineInfo['id']); ?>">查看更多</a></p>
                                            <?php endif; ?>
                                        </div>
                                        <div class="index_message">
                                            <p class="p1">
                                                <span class="company">安全办</span>
                                                <?php if($examineInfo['security_do_examine_status'] == 0): ?>
                                                <span class="examineStatus"><span class="iconfont icon-weishenhe"></span>未审核</span>
                                                <?php elseif($examineInfo['security_do_examine_status'] == 1): ?>
                                                <span class="examineStatus"><span class="iconfont icon-pass-2-copy"></span>审核通过</span>
                                                <?php else: ?>
                                                <span class="examineStatus"><span class="iconfont icon-shenhebohui"></span>审核驳回</span>
                                                <?php endif; ?>
                                            </p>
                                            <p class="p2">审核意见：<?php if($examineInfo['security_do_examine_reason'] != ''): ?><?php echo htmlentities($examineInfo['security_do_examine_reason']); else: ?>无<?php endif; ?></p>
                                            <p class="p2"><span class="iconfont icon-shijian"></span>提交时间：<?php if($examineInfo['security_do_time'] != 0): ?><?php echo date('Y-m-d H:i:s',$examineInfo['security_do_time']); endif; ?></p>
                                        </div>
                                        <div class="index_message">
                                            <p class="p1">
                                                <span class="company">财政所</span>
                                                <?php if($examineInfo['finance_examine_status'] == 0): ?>
                                                <span class="examineStatus"><span class="iconfont icon-weishenhe"></span>未审核</span>
                                                <?php elseif($examineInfo['finance_examine_status'] == 1): ?>
                                                <span class="examineStatus"><span class="iconfont icon-pass-2-copy"></span>审核通过</span>
                                                <?php else: ?>
                                                <span class="examineStatus"><span class="iconfont icon-shenhebohui"></span>审核驳回</span>
                                                <?php endif; ?>
                                            </p>
                                            <p class="p2">审核意见：<?php if($examineInfo['finance_examine_reason'] != ''): ?><?php echo htmlentities($examineInfo['finance_examine_reason']); else: ?>无<?php endif; ?></p>
                                            <p class="p2"><span class="iconfont icon-shijian"></span>提交时间：<?php if($examineInfo['finance_time'] != 0): ?><?php echo date('Y-m-d H:i:s',$examineInfo['finance_time']); endif; ?></p>
                                        </div>
                                        <div class="index_message">
                                            <p class="p1">
                                                <span class="company">镇经发办</span>
                                                <?php if($examineInfo['jing_examine_status'] == 0): ?>
                                                <span class="examineStatus"><span class="iconfont icon-weishenhe"></span>未审核</span>
                                                <?php elseif($examineInfo['jing_examine_status'] == 1): ?>
                                                <span class="examineStatus"><span class="iconfont icon-pass-2-copy"></span>审核通过</span>
                                                <?php else: ?>
                                                <span class="examineStatus"><span class="iconfont icon-shenhebohui"></span>审核驳回</span>
                                                <?php endif; ?>
                                            </p>
                                            <p class="p2">审核意见：<?php if($examineInfo['jing_examine_reason'] != ''): ?><?php echo htmlentities($examineInfo['jing_examine_reason']); else: ?>无<?php endif; ?></p>
                                            <p class="p2"><span class="iconfont icon-shijian"></span>提交时间：<?php if($examineInfo['jing_time'] != 0): ?><?php echo date('Y-m-d H:i:s',$examineInfo['jing_time']); endif; ?></p>
                                        </div>
                                        <div class="index_message">
                                            <p class="p1">
                                                <span class="company">农经站</span>
                                                <?php if($examineInfo['farmer_examine_status'] == 0): ?>
                                                <span class="examineStatus"><span class="iconfont icon-weishenhe"></span>未审核</span>
                                                <?php elseif($examineInfo['farmer_examine_status'] == 1): ?>
                                                <span class="examineStatus"><span class="iconfont icon-pass-2-copy"></span>审核通过</span>
                                                <?php else: ?>
                                                <span class="examineStatus"><span class="iconfont icon-shenhebohui"></span>审核驳回</span>
                                                <?php endif; ?>
                                            </p>
                                            <p class="p2">审核意见：<?php if($examineInfo['farmer_examine_reason'] != ''): ?><?php echo htmlentities($examineInfo['farmer_examine_reason']); else: ?>无<?php endif; ?></p>
                                            <p class="p2"><span class="iconfont icon-shijian"></span>提交时间：<?php if($examineInfo['farmer_time'] != 0): ?><?php echo date('Y-m-d H:i:s',$examineInfo['farmer_time']); endif; ?></p>
                                        </div>
                                        <div class="index_message">
                                            <p class="p1">
                                                <span class="company">审计办</span>
                                                <?php if($examineInfo['audit_examine_status'] == 0): ?>
                                                <span class="examineStatus"><span class="iconfont icon-weishenhe"></span>未审核</span>
                                                <?php elseif($examineInfo['audit_examine_status'] == 1): ?>
                                                <span class="examineStatus"><span class="iconfont icon-pass-2-copy"></span>审核通过</span>
                                                <?php else: ?>
                                                <span class="examineStatus"><span class="iconfont icon-shenhebohui"></span>审核驳回</span>
                                                <?php endif; ?>
                                            </p>
                                            <p class="p2">审核意见：<?php if($examineInfo['audit_examine_reason'] != ''): ?><?php echo htmlentities($examineInfo['audit_examine_reason']); else: ?>无<?php endif; ?></p>
                                            <p class="p2"><span class="iconfont icon-shijian"></span>提交时间：<?php if($examineInfo['audit_time'] != 0): ?><?php echo date('Y-m-d H:i:s',$examineInfo['audit_time']); endif; ?></p>
                                        </div>
                                        <div class="index_message">
                                            <p class="p1">
                                                <span class="company">镇资产公司</span>
                                                <?php if($examineInfo['assets_examine_status'] == 0): ?>
                                                <span class="examineStatus"><span class="iconfont icon-weishenhe"></span>未审核</span>
                                                <?php elseif($examineInfo['assets_examine_status'] == 1): ?>
                                                <span class="examineStatus"><span class="iconfont icon-pass-2-copy"></span>审核通过</span>
                                                <?php else: ?>
                                                <span class="examineStatus"><span class="iconfont icon-shenhebohui"></span>审核驳回</span>
                                                <?php endif; ?>
                                            </p>
                                            <p class="p2">审核意见：<?php if($examineInfo['assets_examine_reason'] != ''): ?><?php echo htmlentities($examineInfo['assets_examine_reason']); else: ?>无<?php endif; ?></p>
                                            <p class="p2"><span class="iconfont icon-shijian"></span>提交时间：<?php if($examineInfo['assets_time'] != 0): ?><?php echo date('Y-m-d H:i:s',$examineInfo['assets_time']); endif; ?></p>
                                        </div>
                                        <div class="index_message">
                                            <p class="p1">
                                                <span class="company">经管办</span>
                                                <?php if($examineInfo['management_examine_status'] == 0): ?>
                                                <span class="examineStatus"><span class="iconfont icon-weishenhe"></span>未审核</span>
                                                <?php elseif($examineInfo['management_examine_status'] == 1): ?>
                                                <span class="examineStatus"><span class="iconfont icon-pass-2-copy"></span>审核通过</span>
                                                <?php else: ?>
                                                <span class="examineStatus"><span class="iconfont icon-shenhebohui"></span>审核驳回</span>
                                                <?php endif; ?>
                                            </p>
                                            <p class="p2">审核意见：<?php if($examineInfo['management_examine_reason'] != ''): ?><?php echo htmlentities($examineInfo['management_examine_reason']); else: ?>无<?php endif; ?></p>
                                            <p class="p2"><span class="iconfont icon-shijian"></span>提交时间：<?php if($examineInfo['management_time'] != 0): ?><?php echo date('Y-m-d H:i:s',$examineInfo['management_time']); endif; ?></p>
                                            <?php if($examineInfo['management_examine_status'] != 0): ?>
                                            <p class="p2 p3"><a href="/examine/managementMore?demandId=<?php echo htmlentities($examineInfo['id']); ?>">查看更多</a></p>
                                            <?php endif; ?>
                                        </div>
                                        <div class="index_message">
                                            <p class="p1">
                                                <span class="company">镇领导</span>
                                                <?php if($examineInfo['town_examine_status'] == 0): ?>
                                                <span class="examineStatus"><span class="iconfont icon-weishenhe"></span>未审核</span>
                                                <?php elseif($examineInfo['town_examine_status'] == 1): ?>
                                                <span class="examineStatus"><span class="iconfont icon-pass-2-copy"></span>审核通过</span>
                                                <?php else: ?>
                                                <span class="examineStatus"><span class="iconfont icon-shenhebohui"></span>审核驳回</span>
                                                <?php endif; ?>
                                            </p>
                                            <p class="p2">审核意见：<?php if($examineInfo['town_examine_reason'] != ''): ?><?php echo htmlentities($examineInfo['town_examine_reason']); else: ?>无<?php endif; ?></p>
                                            <p class="p2"><span class="iconfont icon-shijian"></span>提交时间：<?php if($examineInfo['town_time'] != 0): ?><?php echo date('Y-m-d H:i:s',$examineInfo['town_time']); endif; ?></p>
                                        </div>
                                    <?php elseif(($demondInfo['apple_process_type'] == 0) && ($demondInfo['apple_is_soft_first'] == 0)): ?><!--,常规流程不需要安全预审-->
                                        <div class="index_message">
                                            <p class="p1">
                                    ...
                                    <?php endif; if(($role == 8) && ($examineInfo['management_examine_status'] == 0)): ?>
                                    <div class="index_message">
                                        <a class="btn btn-primary btn-lg btn-block edit" href="/Examine/managementDemand?demandId=<?php echo htmlentities($examineInfo['id']); ?>">去审核</a>
                                    </div>
                                    <?php endif; ?>
                                    </div>
                                </div>
                                <?php elseif($demondInfo['apple_status'] == 2): ?><!--通过-->
                                <div class="row special-row">
                                    <div class="col-lg-12 col-md-12 margin-top-10 margin-bottom-10 specia-m">
                                        <?php if(($demondInfo['apple_process_type'] == 0) && ($demondInfo['apple_is_soft_first'] == 1)): ?><!--,常规流程需要安全预审-->
                                        <div class="index_message">
                                ...
                                <div class="row special-row">
                                    <div class="col-lg-12 col-md-12 margin-top-10 margin-bottom-10 specia-m">
                                        ...
                                        <?php endif; if($role == 0): ?>
                                        <div class="index_message">
                                            <a class="btn btn-primary btn-lg btn-block edit" href="/Examine/releaseDemand?demandId=<?php echo htmlentities($demondInfo['apple_id']); ?>">修改</a>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
