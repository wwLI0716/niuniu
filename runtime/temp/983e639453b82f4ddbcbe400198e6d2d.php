                            ...
                            <form id="demandInfo" name="demandInfo" action="<?php echo url('getreleaseDemand'); ?>" enctype="multipart/form-data" method="post">
                                ...
                                <div>
                                    ...
                                    <div class="show-module-content" style="display: none;">
                                        ...
                                        <div class="form-group row">
                                            <textarea class="form-control col-sm-6" name="explain" id="explain" rows="5"><?php if(isset($demondInfo['explain']) && $demondInfo['explain'] != ''): ?><?php echo htmlentities($demondInfo['explain']); else: ?>特殊情况说明<?php endif; ?></textarea>
