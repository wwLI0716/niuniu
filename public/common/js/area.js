...
function _init_area(area_opt){  //初始化函数
	// var area_opt = ["江苏省","常州市","武进区"];//测试
	opt0 = area_opt;
	if(area_opt[0]=="" || area_opt[1]=="" || area_opt[2]==""){
		opt0 = ["省份","地级市"," 市、县级市"];
	}
	//if(area_opt[0]=="江苏省" || area_opt[1]=="" || area_opt[2]==""){
	//	//opt0 = ["省份","地级市"," 市、县级市"];
	//	var opts = document.getElementById("s_province");
	//	var value = "江苏省";
	//	$("#s_province option:first").hide();
	//	if(value!=""){
